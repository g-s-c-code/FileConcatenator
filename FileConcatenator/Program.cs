...
internal class Program
{
	...
	{
		{"Default", new Theme(Color.White, Color.Grey78, Color.RosyBrown, Color.SteelBlue1_1, Color.Grey78, TableBorder.DoubleEdge)},
		{"Minimalistic", new Theme(Color.White, Color.White, Color.White, Color.White, Color.Black, TableBorder.None)},
		{"Pastel", new Theme(Color.LightCyan3, Color.MistyRose1, Color.LightSteelBlue1, Color.PaleGreen3_1, Color.PaleVioletRed1, TableBorder.Square)},
		{"Hacker", new Theme(Color.Green1, Color.Green1, Color.Green1, Color.Green1, Color.Green1, TableBorder.Double)}
	};
